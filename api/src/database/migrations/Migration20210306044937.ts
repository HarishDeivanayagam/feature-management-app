...
export class Migration20210306044937 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "feedback_group" ("id" serial primary key, "feedback" varchar(250) not null, "description" varchar(500) not null, "count" int4 not null default 0, "creator" varchar(255) not null default \'ML_API\', "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null);');

    this.addSql('create table "feedback" ("id" serial primary key, "feedback" varchar(250) not null, "description" varchar(500) not null, "tenant_id" varchar(255) not null, "is_grouped" bool not null default false, "group_id" int4 null, "creator_name" varchar(50) null, "creator_email" varchar(100) null, "is_closed" bool not null default false, "segment_id" int4 not null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null);');
    ...
    this.addSql('alter table "feedback" add constraint "feedback_segment_id_foreign" foreign key ("segment_id") references "segments" ("id") on update cascade;');
  }
